    ...
    return (
        <footer className="w-full bg-[var(--color-brand-black)] text-zinc-300 border-t border-zinc-800 pt-10 pb-8 mt-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
                ...
                {/* 2. Main Footer Grid (Brand Info, Quick Links, Contact Us) */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-8 border-b border-zinc-800">
                    ...
                    {/* Col 4: Contact Us & Omnichannel Social Links */}
                    <div className="space-y-3">
                        <h4 className="text-sm font-bold uppercase tracking-wider text-white border-l-2 border-[var(--color-brand-red)] pl-2.5">
                            Contact Us
                        </h4>
                        <div className="space-y-1.5 text-xs text-zinc-400">
                            <p className="text-white font-medium">✉️ อีเมลบริษัท:</p>
                            <a
                                href="mailto:admin@sorncarcareshop.com"
                                className="block text-zinc-300 hover:text-[var(--color-brand-red)] transition-colors break-all underline decoration-zinc-700 underline-offset-4"
                            >
                                admin@sorncarcareshop.com
                            </a>
                        </div>
